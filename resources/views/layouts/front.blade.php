...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrap">
							...
							<div class="row">
								<div class="col-md-6 d-flex align-items-center">
									<p class="mb-0 phone pl-md-2">
										<a href="#" class="mr-2"><span class="fa fa-phone mr-1"></span> +22991121293</a> 
										<a href="#"><span class="fa fa-paper-plane mr-1"></span> www.Taskbénin.net</a>
									</p>
								</div>
	    ...
	    <div class="container">
	    	<a class="navbar-brand" href="index.html">TaskBénin</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav m-auto">
	        	...
	        	<li class="nav-item"><a href="about.html" class="nav-link">En savoir plus</a></li>
	        	<li class="nav-item"><a href="services.html" class="nav-link">Connexion</a></li>
    ...
    <div class="hero-wrap">
	    <div class="home-slider owl-carousel">
	      <div class="slider-item" style="background-image:url(front/images/168031.jpg);">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row no-gutters slider-text align-items-center justify-content-center">
		          <div class="col-md-8 ftco-animate">
		          	<div class="text w-100 text-center">
		          		<h2>Vos tache notre priorité</h2>
			            <h1 class="mb-4">Nous vous aidons dans l'accomplissements de vos tache</h1>
			            <p><a href="#" class="btn btn-white">Connectez vous a votre compte</a></p>
		            </div>
		          </div>
		        </div>
	        </div>
	      ...
	      <div class="slider-item" style="background-image:url(front/images/656329.jpg);">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row no-gutters slider-text align-items-center justify-content-center">
		          <div class="col-md-8 ftco-animate">
		          	<div class="text w-100 text-center">
		          		<h2>Nous enregistrons vos tache</h2>
			            <h1 class="mb-4">Meilleurs platforme pour la gestion des taches</h1>
			            <p><a href="#" class="btn btn-white">Connectez vous a votre compte</a></p>
		            </div>
		          </div>
		        </div>
	      ...
	      <div class="slider-item" style="background-image:url(front/images/889800.jpg);">
	      	<div class="overlay"></div>
	        <div class="container">
	          <div class="row no-gutters slider-text align-items-center justify-content-center">
		          <div class="col-md-8 ftco-animate">
		          	<div class="text w-100 text-center">
		          		<h2>Controler vos taches</h2>
			            <h1 class="mb-4">laisser nous certains ppints</h1>
			            <p><a href="#" class="btn btn-white">Connectez vous a votre compte</a></p>
		            </div>
		          </div>
		        </div>
    	...
    	<div class="container">
    		<div class="row d-flex no-gutters">
    			<div class="col-md-6 d-flex">
    				<div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-center mb-4 mb-sm-0" style="background-image:url(front/images/708114.jpg);">
    				</div>
    			</div>
    			<div class="col-md-6 pl-md-5 py-md-5">
    				<div class="heading-section pl-md-4 pt-md-5">
    					<span class="subheading">Bienvenue a TaskBénin</span>
	            <h4 class="mb-4"><strong>Nous somme la meilleurs agence de gestion des tache au Bénin</strong></h4>
    				</div>
    				<div class="services-2 w-100 d-flex">
    					<div class="icon d-flex align-items-center justify-content-center"><span class="flaticon-wealth"></span></div>
    					<div class="text pl-4">
    						<h4>Analyse de tache</h4>
    						<p></p>
    					</div>
    				</div>
    				<div class="services-2 w-100 d-flex">
    	...
    	<div class="container">
          ...
          <div class="col-md-6 col-lg-3 d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18 text-center">
              ...
              <div class="text">
              	<span>tache total accomplir</span>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex justify-content-center counter-wrap ftco-animate">
                ...
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/400094400174_72089.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Tony da Costa</p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    <p class="mb-4">....</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/IMG_20210503_194134_234.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">ADJAKIN Landry</p>
		                    <span class="position">Marketing man</span>
		                  </div>
	                  </div>
                  </div>
                </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    <p class="mb-4"></p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/400088300913_81036.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Stephane SEPHANDE</p>
    		...
    		<div class="row">
    			<div class="col-lg-6">
    				<div class="img-faqs w-100">
	    				<div class="img mb-4 mb-sm-0" style="background-image:url(front/images/IMG-20200926-WA0001.jpg);">
	    				</div>
	    				<div class="img img-2 mb-4 mb-sm-0" style="background-image:url(front/images/IMG-20201009-WA0032.jpg);">
	    				</div>
	    			</div>
    			</div>
      ...
      <div class="container">
        <div class="row justify-content-center pb-5 mb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
          	<span class="subheading">Nouvelle &amp; Blog</span>
            <h2>Les dernières nouvelles depuis le blog</h2>
          </div>
        </div>
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 rounded" style="background-image: url('images/400088300913_81036.jpg');">
              </a>
              <div class="text p-4">
              	<div class="meta mb-2">
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 rounded" style="background-image: url('images/400088300913_810365.jpg');">
              </a>
              <div class="text p-4">
              	<div class="meta mb-2">
                  <div><a href="#">March 31, 2020</a></div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20 rounded" style="background-image: url('images/400094400174_72089.jpg');">
              </a>
              <div class="text p-4">
              	<div class="meta mb-2">
                  <div><a href="#">March 31, 2020</a></div>
